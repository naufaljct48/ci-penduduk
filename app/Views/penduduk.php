    ...
    $(document).ready(function() {
        var table = $("#tablePenduduk").DataTable({
            ...
            columns: [{
                ...
                {
                    data: function(row) {
                        let html = '<button class="btn btn-warning btn-sm mr-1" data-toggle="modal" data-target="#editData" data-id="' + row.id + '" data-penduduk="' + row.penduduk + '" data-bulan="' + row.bulan + '" data-tahun="' + row.tahun + '"><i class="fas fa-edit"></i></button>';
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="form-group row">
                    ...
                    <div class="col-sm-7">
                        <input type="number" class="form-control" name="penduduk" id="penduduk" placeholder="Jumlah Penduduk" value="">
                    </div>
                </div>
                <div class="form-group row">
                    <div class="col-sm-5 col-form-label">
